...
public class QRS_test {
  ...
  public QRS_test(){
    ArrayList<String> data_list = readCSVToArrayList("C:\\Users\\mobou\\OneDrive\\schooljaar 2016-2017\\International Project\\qrsserver\\src\\main\\java\\hello\\data.csv");
    ...
    List<Integer> intList = new ArrayList<Integer>(QRS.length);
    ...
    for (int i : intList) {
      if(i != 0)
      System.out.println(Integer.toString(i) + "@ " + String.valueOf(intList.indexOf(i)));
    }
